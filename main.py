...
if __name__ == '__main__':
   ...
   # manager.default_insert()
    ...
    print("Список навыков:", manager.get_skills())
    
    manager.insert_project([(1, 'Project Sigma', 'aoaoaoaoaoaoa', 'http://skibidi_sigma.com', 1)])
    print("Проекты пользователя 1:", manager.get_projects(1))


    manager.update_projects('description', ('Новое описание', 'Project Sigma', 1))
    print("Обновленный проект:", manager.get_projects(1))
